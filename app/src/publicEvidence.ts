...
export const publicEvidence: PublicEvidenceItem[] = [
  ...
  { id: 'ai-review', date: '2026-09-18', label: 'Groq AI recommendation', detail: 'Groq openai/gpt-oss-20b returned RECOMMEND_ACCEPT. The system recorded field-name presence and the selected source-byte range.', identifier: 'bytes 0–747', status: 'verified' },
